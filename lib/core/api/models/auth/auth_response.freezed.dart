...
abstract class $AuthResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String refreshToken, String token, int tokenExpires, User user});
...
class _$_AuthResponse extends _AuthResponse with DiagnosticableTreeMixin {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AuthResponse(refreshToken: $refreshToken, token: $token, tokenExpires: $tokenExpires, user: $user)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('tokenExpires', tokenExpires))
